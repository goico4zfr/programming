...
$data = array();
if ($sql = $conn->query("SELECT * FROM majors "));
if ($sql->num_rows) {
                ...
                <div class="container px-5">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 small fw-bolder">
                            ...
                            <li class="nav-item"><a class="nav-link active" href="programs_list.php">Programs List</a></li>
                                ...
                                <div class="row gx-5 justify-content-center">
                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($data as $n) {?>
                                                <tr id="<?php echo $n->Program_Code; ?>">
                                                    <td><?php echo $n->Program_Title; ?></td>
                                                    <td><?php echo $n->Total_Credit_Hours; ?></td>
